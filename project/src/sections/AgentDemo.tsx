...
export default function AgentDemo() {
  ...
  const handleScroll = (e: React.UIEvent<HTMLDivElement>) => {
    ...
    setActivePage(scrollPercent > 0.5 ? 1 : 0);
  };
      ...
      <div className="container-standard w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="pt-0">
            ...
            <p className="text-base text-slate-500 font-bold max-w-xl mb-8 leading-relaxed">
            ...
            <div className="flex gap-6 items-start mb-8">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <div className={`w-1 h-12 rounded-full transition-colors duration-300 ${activePage === 0 ? 'bg-slate-900' : 'bg-slate-100'}`} />
                <div className={`w-1 h-12 rounded-full transition-colors duration-300 ${activePage === 1 ? 'bg-slate-900' : 'bg-slate-100'}`} />
              </div>

              <div
                ref={scrollRef}
                onScroll={handleScroll}
                className="h-[240px] w-full overflow-y-auto pr-4 custom-scrollbar"
              >
